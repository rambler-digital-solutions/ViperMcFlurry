...
- (void)perform {
    ...
    UIViewController<RamblerViperEmbedModuleContainer> *parentViewController = self.sourceViewController;
    UIViewController *embeddableModuleViewController = self.destinationViewController;
    
    if (![parentViewController conformsToProtocol:@protocol(RamblerViperEmbedModuleContainer)]) {
